...
// add your code here
//you're right, I'm gonna kick myself.
for(let i= 0; i<= 8; ++i)
{
    document.querySelector("#pictures").innerHTML += "<article class='card'>" +
        "<h2>" + picArray[i]['title'] + "</h2>" +
        "<figure> <img src=" + picArray[i]['image']['medium'] + "alt=" + picArray[i]['title'] + ">" +
